...
if os.path.isfile("label_list"):
	...
	# emotional stability
	X_t1 = []
	for a, b in izip(X_baseline_angle, X_slant_angle):
		X_t1.append([a, b])
	
	# mental energy or will power
	X_t2 = []
	for a, b in izip(X_letter_size, X_pen_pressure):
		X_t2.append([a, b])
		
	# modesty
	X_t3 = []
	for a, b in izip(X_letter_size, X_top_margin):
		X_t3.append([a, b])
		
	# personal harmony and flexibility
	X_t4 = []
	for a, b in izip(X_line_spacing, X_word_spacing):
		X_t4.append([a, b])
		
	# lack of discipline
	X_t5 = []
	for a, b in izip(X_slant_angle, X_top_margin):
		X_t5.append([a, b])
		
	# poor concentration
	X_t6 = []
	for a, b in izip(X_letter_size, X_line_spacing):
		X_t6.append([a, b])
		
	# non communicativeness
	X_t7 = []
	for a, b in izip(X_letter_size, X_word_spacing):
		X_t7.append([a, b])
	...
	while True:
		...
		if file_name == 'z':
			break
		# file_name = "hwsample_jennifermather.jpeg"
